    ...
    <Card className="bg-white dark:bg-[#262626] text-gray-900 dark:text-white">
      <CardContent className="p-6">
        ...
        <div className="mb-4 flex flex-col items-start justify-between gap-2 md:flex-row md:items-center">
          <h2 className="text-xl font-semibold">Daftar Purchase</h2>
          <button
        ...
        <div className="mb-4">
          <input
            ...
            className="w-full rounded-md border border-gray-300 dark:border-gray-600 bg-gray-100 dark:bg-[#333] px-3 py-2 text-sm text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-600"
          />
        </div>
        ...
        {isLoading && (
          <div className="space-y-2">
            {[...Array(5)].map((_, i) => (
              <div
                key={i}
                className="h-10 w-full animate-pulse rounded bg-gray-200 dark:bg-[#333]"
              ></div>
            ))}
          </div>
        )}
            ...
            <table className="w-full border-collapse border border-gray-300 dark:border-gray-600 text-sm">
              <thead>
                <tr className="bg-gray-200 dark:bg-[#333] text-gray-700 dark:text-gray-300">
                  ...
                  <th className="border  border-gray-300 dark:border-gray-600 px-3 py-2 text-left">Supplier</th>
                  ...
                  <th className="border  border-gray-300 dark:border-gray-600 px-3 py-2 text-left">Harga</th>
                  <th className="border  border-gray-300 dark:border-gray-600 px-3 py-2 text-left">Total</th>
                  <th className="border  border-gray-300 dark:border-gray-600 px-3 py-2 text-left">Grand Total</th>
                  <th className="border  border-gray-300 dark:border-gray-600 px-3 py-2 text-left">Aksi</th>
                </tr>
              </thead>
              <tbody>
                {currentPurchases.map((purchase) => (
                  ...
                  >
                    ...
                    <td className="border  border-gray-300 dark:border-gray-600 px-3 py-2 font-bold text-green-600 dark:text-green-400">
                      {purchase.grandTotal.toLocaleString("id-ID", {
                        style: "currency",
                        currency: "IDR",
                      })}
                    </td>
                    <td className="border border-gray-300 dark:border-gray-600 px-3 py-2 flex gap-2">
                      <button
        ...
        {!isLoading && currentPurchases.length > 0 && (
          <div className="block md:hidden space-y-4">
            {currentPurchases.map((purchase) => (
              <Card
                key={purchase._id}
                className="bg-gray-100 dark:bg-[#1f1f1f] border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white"
              >
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 mt-4">
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="rounded-md border border-gray-300 dark:border-gray-600 bg-gray-100 dark:bg-[#333] px-2 py-1 text-sm text-gray-900 dark:text-white"
              >
                {[5, 10, 20, 50].map((n) => (
        ...
        {/* Summary */}
        <Card className="mt-4 bg-gray-100 dark:bg-[#1f1f1f] border border-gray-300 dark:border-gray-700">
          <CardContent className="p-4 flex justify-between items-center">
            <h3 className="text-lg font-semibold">Total Belanja</h3>
            <p className="text-xl font-bold text-green-600 dark:text-green-400">
              {totalGrand.toLocaleString("id-ID", {
                style: "currency",
                currency: "IDR",
              })}
            </p>
